...
def train_loop(config, msg = "default"):
    ...
    result_path = './results_mujoco_utd/{}/{}/{}/{}_{}_{}_{}'.format(config.env_name, config.algo, msg, 
    ...
    files_to_save = ['main.py', 'envs', 'model', 'utilis']
...
if __name__ == "__main__":
    arg = ARGConfig()
    arg.add_arg("env_name", "Humanoid-v3", "Environment name")
